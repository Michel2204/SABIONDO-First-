...
const TITULOS: Record<Juego, string> = {
  trivia: "DUELO 1 vs 1",
  ahorcado: "AHORCADO 1 vs 1",
  damas: "DAMAS",
  ajedrez: "AJEDREZ",
};

export default function PantallaSalas({
  usuarioId,
  juego = "trivia",
  onSalaLista,
  onVolver,
  ...
  return (
    ...
    >
      ...
      <h2 className="font-display text-3xl text-crema mb-6 text-center">{TITULOS[juego]}</h2>
